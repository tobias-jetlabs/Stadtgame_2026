...
const DEFAULT_STATE = {
  ...
  territories: {
    ...
    '1':  { number: 2,  label: 'Nordtor',        resourceType: 'iron',  owner: null, adjacentTo: [2, 5],        isCapital: false },
    '2':  { number: 3,  label: 'Eisenberg',      resourceType: 'iron',  owner: null, adjacentTo: [1, 3, 6],      isCapital: false },
    '3':  { number: 11, label: 'Felsklippe',     resourceType: 'iron',  owner: null, adjacentTo: [2, 4, 7],      isCapital: false },
    '4':  { number: 12, label: 'Ostflanke',      resourceType: 'iron',  owner: null, adjacentTo: [3, 8],         isCapital: false },

    // ── Row 1 – outer ring (Stein) ──
    '5':  { number: 4,  label: 'Stadttor',       resourceType: 'stone', owner: null, adjacentTo: [1, 6, 9],      isCapital: false },
    '6':  { number: 10, label: 'Brunnen',        resourceType: 'stone', owner: null, adjacentTo: [2, 5, 7, 10],  isCapital: false },
    '7':  { number: 4,  label: 'Klostermauer',  resourceType: 'stone', owner: null, adjacentTo: [3, 6, 8, 11],  isCapital: false },
    '8':  { number: 10, label: 'Steinbruch',     resourceType: 'stone', owner: null, adjacentTo: [4, 7, 12],     isCapital: false },

    // ── Row 2 – mid ring (Holz + Stein mix) ──
    '9':  { number: 5,  label: 'Waldrand',       resourceType: 'wood',  owner: null, adjacentTo: [5, 10, 13],    isCapital: false },
    '10': { number: 9,  label: 'Mühle',          resourceType: 'wood',  owner: null, adjacentTo: [6, 9, 11, 14], isCapital: false },
    '11': { number: 5,  label: 'Holzfäller',     resourceType: 'wood',  owner: null, adjacentTo: [7, 10, 12, 15],isCapital: false },
    '12': { number: 9,  label: 'Sägewerk',       resourceType: 'wood',  owner: null, adjacentTo: [8, 11, 16],    isCapital: false },

    // ── Row 3 – inner ring (Holz, most productive) ──
    '13': { number: 6,  label: 'Marktplatz',     resourceType: 'stone', owner: null, adjacentTo: [9, 14, 17],    isCapital: false },
    '14': { number: 8,  label: 'Rathausplatz',   resourceType: 'wood',  owner: null, adjacentTo: [10, 13, 15, 18],isCapital: false },
    '15': { number: 6,  label: 'Waffenschmiede', resourceType: 'wood',  owner: null, adjacentTo: [11, 14, 16, 19],isCapital: false },
    '16': { number: 8,  label: 'Kräutergarten',  resourceType: 'wood',  owner: null, adjacentTo: [12, 15, 20],   isCapital: false },

    // ── Row 4 – core center ──
    '17': { number: 6,  label: 'Burghügel',      resourceType: 'wood',  owner: null, adjacentTo: [13, 18, 21],   isCapital: false },
    '18': { number: 8,  label: 'Fischergasse',   resourceType: 'wood',  owner: null, adjacentTo: [14, 17, 19, 22],isCapital: false },
    '19': { number: 8,  label: 'Mühlbach',       resourceType: 'wood',  owner: null, adjacentTo: [15, 18, 20, 23],isCapital: false },
    '20': { number: 6,  label: 'Klostergasse',   resourceType: 'stone', owner: null, adjacentTo: [16, 19, 24],   isCapital: false },

    // ── Row 5 – south outer ring (Stein + Eisen) ──
    '21': { number: 3,  label: 'Südtor',         resourceType: 'iron',  owner: null, adjacentTo: [17, 22],       isCapital: false },
    '22': { number: 11, label: 'Flussübergang',  resourceType: 'stone', owner: null, adjacentTo: [18, 21, 23],   isCapital: false },
    '23': { number: 3,  label: 'Ackerland',      resourceType: 'stone', owner: null, adjacentTo: [19, 22, 24],   isCapital: false },
    '24': { number: 11, label: 'Habsburg Burg',  resourceType: 'iron',  owner: null, adjacentTo: [20, 23],       isCapital: true  },
  },
